...
export function DashboardHeader() {
  ...
  return (
    <header className="sticky top-0 z-10 flex h-28 items-center gap-4 border-b bg-card px-6 shadow-sm">
      <SidebarTrigger />
      
      <div className="flex items-center flex-1 justify-center">
        <img src={collegeLogo} alt="College Logo" className="h-24 w-auto object-contain max-w-md" />
      </div>
